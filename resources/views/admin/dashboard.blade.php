 ...
 @include('Admin.sidebarAdmin')
  ...
  <div class="main-content" style="margin-left: 250px; padding: 20px;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="p-4 bg-white rounded shadow">Total Books: 123</div>
            <div class="p-4 bg-white rounded shadow">Users: 87</div>
            <div class="p-4 bg-white rounded shadow">Orders: 45</div>
        </div>

        <!-- You can include more sections below -->
    </div>
  <!-- Left Arrow -->
