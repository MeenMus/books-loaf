...
<body>
  ...
  <div class="main-content p-6">
    <div class="flex justify-between items-center mb-6">
      <h3 class="text-2xl font-bold">Manage Genres</h3>
    </div>

    <div class="grid grid-cols-1">
      <div class="admin-card bg-white p-4 rounded shadow">
        <div class="table-responsive">
          <table id="genresTable" class="table-auto w-full text-left border">
            ...
            <tbody>
              ...
              <tr class="border-t">
                ...
                <td class="px-4 py-2 text-center">
                  <form action="{{ route('delete-genres') }}" method="POST" onsubmit="return confirm('Delete this genre?');">
                    @csrf
  ...
  <div class="modal fade" id="addgenreModal" tabindex="-1" aria-labelledby="addgenreModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('store-genres') }}" method="POST">
          @csrf
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      $('#genresTable').DataTable({
        ...
        scrollY: '300px',
        scrollCollapse: true,
        dom: 'f' // Only show the search bar (filter)
      });
    });
  </script>
</body>
