      ...
      <div class="col-12 d-flex">
        <div class="card p-4 fs-6">
          <div class="d-flex flex-wrap">
            <!-- Book Cover -->
            <div class="me-4 mb-1 editable-cover" style="flex: 0 0 45%; position: relative; cursor: pointer;">
            ...
            <div style="flex: 1;">
              ...
              <div class="mb-1">
                <form action="{{ route('books-delete', $book->id) }}" method="POST" class="d-inline float-end">
                  @csrf
                  @method('DELETE')
