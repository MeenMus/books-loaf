...
<div class="row g-4 align-items-stretch">
  ...
  <div class="col-md-8 d-flex flex-column">
    ...
    <div class="card p-4 w-100 mb-4">
      <h5 class="mb-3 fw-bold">Top Purchased Books</h5>
      <canvas id="topBooksChart" height="200"></canvas>
    </div>

    <!-- Card: Book Categories Breakdown -->
    <div class="card p-3 w-100">
      <h5 class="mb-4 fw-bold">Book Categories Breakdown</h5>
...
<div class="row mt-1 g-4">
  ...
  <div class="col-md-4 d-flex">
    <div class="card p-4 fs-6 w-100">
      <h4 class="fw-bold">Address Information</h4>
      <hr>
  ...
  <script>
    ...
    const categoryPieChart = new Chart(categoryCtx, {
      ...
      options: {
        ...
        plugins: {
          title: {
            display: false // Already handled by <h5>
          },
          legend: {
            display: true,
            position: 'bottom',
