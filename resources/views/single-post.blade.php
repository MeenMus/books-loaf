            ...
            <article class="post-item">
              <div class="post-content">
                <div class="post-meta mt-4">
                  <span class="post-category">Feb 22, 2024 </span> - <span class="meta-date"><a href="blog">Books</a></span>
                </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 posts mb-4">
          ...
          <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post">5 Must-Have Gadgets for
        ...
        <div class="col-md-3 posts mb-4">
          ...
          <a href="blog" class="fs-6 text-primary">Books</a>
          <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post">Eco-Friendly Innovations
        ...
        <div class="col-md-3 posts mb-4">
          ...
          <a href="blog" class="fs-6 text-primary">Books</a>
          <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post">The Future of Wearable
        ...
        <div class="col-md-3 posts mb-4">
          ...
          <a href="blog" class="fs-6 text-primary">Books</a>
          <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post">Top Apps and Tools for
              Remote Work</a></h4>
