          ...
          <div class="row product-content product-store">
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">Blood on the Snow</a></h6>
            ...
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">Story of Success</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">City of the Dead</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">The Dirty and Dead</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">Life Flight</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">The Colors of Life</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="col-lg-3 col-md-4 mb-4">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="single-product">Mask of Death</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
